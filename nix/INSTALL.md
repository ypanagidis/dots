...
- ghostty/zsh/tmux/nvim/btop are managed natively by home-manager modules;
  migrating them to the shared `dots/` copies is a deliberate per-app
  follow-up (see `modules/dots.nix` header).
